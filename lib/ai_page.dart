...
class _AIPageState extends State<AIPage> {
  ...
  // Future<String> _buildBudgetRecommendationPrompt(String userPrompt, String startDate, String endDate) async {
  //   final uid = getCurrentUserID();
  ...
  //   // Fetching and summarizing expenses based on the dynamic startDate and endDate
  //   final expenseSummary = await fetchAndSummarizeExpenses(uid, startDate, endDate);
  //   if (expenseSummary.isEmpty) {
  //     throw Exception("No expense data available for the selected period.");
  //   }
